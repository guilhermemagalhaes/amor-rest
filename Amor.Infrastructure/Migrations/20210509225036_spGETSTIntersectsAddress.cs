...
{
    public partial class spGETSTIntersectsAddress : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sp = @"CREATE PROCEDURE GETSTIntersectsAddress
...
SELECT	geography::Point(a.Longitude, a.Longitude, 4326) as POINT,
		a.eventid	
FROM	Address a
